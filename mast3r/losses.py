...
class MatchingLoss_Scale16 (Criterion, MultiLoss):
    ...
    def __init__(self, criterion, withconf=True, use_pts3d=False, negatives_padding=0, blocksize=4096):
        ...
        self.negatives_padding = negatives_padding
        self.use_pts3d = use_pts3d
        assert use_pts3d == False, 'Only support desc matching'
        self.blocksize = blocksize
        self.withconf = withconf
    ...
    def get_confs(self, pred1, pred2, sel1, sel2):
        if self.withconf:
            if self.use_pts3d:
                ...
                outconfs1 = pred1['desc_conf_16'][sel1]
                outconfs2 = pred2['desc_conf_16'][sel2]
        else:
            outconfs1 = outconfs2 = None
        return outconfs1, outconfs2
    ...
    def get_descs(self, pred1, pred2):
        if self.use_pts3d:
            ...
            desc1, desc2 = pred1['desc_16'], pred2['desc_16']
        return desc1, desc2
...
class MatchingLoss_Scale8 (Criterion, MultiLoss):
    """ 
    Matching loss per image 
    only compare pixels inside an image but not in the whole batch as what would be done usually
    """
    ...
    def get_confs(self, pred1, pred2, sel1, sel2):
        if self.withconf:
            if self.use_pts3d:
                ...
                outconfs1 = pred1['desc_conf_8'][sel1]
                outconfs2 = pred2['desc_conf_8'][sel2]
        else:
            outconfs1 = outconfs2 = None
        return outconfs1, outconfs2
    ...
    def get_descs(self, pred1, pred2):
        if self.use_pts3d:
            ...
            desc1, desc2 = pred1['desc_8'], pred2['desc_8']
        return desc1, desc2
...
class MatchingLoss_Scale4 (Criterion, MultiLoss):
    """ 
    Matching loss per image 
    only compare pixels inside an image but not in the whole batch as what would be done usually
    """
    ...
    def get_confs(self, pred1, pred2, sel1, sel2):
        if self.withconf:
            if self.use_pts3d:
                ...
                outconfs1 = pred1['desc_conf_4'][sel1]
                outconfs2 = pred2['desc_conf_4'][sel2]
        else:
            outconfs1 = outconfs2 = None
        return outconfs1, outconfs2
    ...
    def get_descs(self, pred1, pred2):
        if self.use_pts3d:
            ...
            desc1, desc2 = pred1['desc_4'], pred2['desc_4']
        return desc1, desc2
...
class MatchingLoss_Scale2 (Criterion, MultiLoss):
    """ 
    Matching loss per image 
    only compare pixels inside an image but not in the whole batch as what would be done usually
    """
    ...
    def get_confs(self, pred1, pred2, sel1, sel2):
        if self.withconf:
            if self.use_pts3d:
                ...
                outconfs1 = pred1['desc_conf_2'][sel1]
                outconfs2 = pred2['desc_conf_2'][sel2]
        else:
            outconfs1 = outconfs2 = None
        return outconfs1, outconfs2
    ...
    def get_descs(self, pred1, pred2):
        if self.use_pts3d:
            ...
            desc1, desc2 = pred1['desc_2'], pred2['desc_2']
        return desc1, desc2
