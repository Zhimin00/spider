...
from spider.utils.utils import match, match_upsample, sample_symmetric, to_pixel_coordinates, tensor_to_pil, fmwarp_match
...
with torch.no_grad():
    ...
    draw_matches(spider_kpts1, spider_kpts2, spider_mconf, name='spiderfmwarp_matches.png')
